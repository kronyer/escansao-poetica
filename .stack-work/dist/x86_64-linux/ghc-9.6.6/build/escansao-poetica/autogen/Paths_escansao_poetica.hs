...
sysconfdir = "/home/pedro/Documentos/Estudo/escansao-poetica/.stack-work/install/x86_64-linux/bf057d41f7600277f787fa5860451340296e39e35339aea029e229277e91682f/9.6.6/etc"

getBinDir     = catchIO (getEnv "escansao_poetica_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "escansao_poetica_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "escansao_poetica_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "escansao_poetica_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "escansao_poetica_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "escansao_poetica_sysconfdir") (\_ -> return sysconfdir)
